...
function dogBreedGame() {
  ...
  for (let i = 0; i < NUM_OF_PICTURES; i++) {
    ...
    dogs[i].addEventListener("click", function() {
      ...
      document.getElementById("jumbotron-message").classList.remove("fadeOut");
      void document.getElementById("jumbotron-message").offsetWidth;
      ...
      if ((clickedImage === randomDog) && firstClick) {
        ...
        void document.getElementById("jumbotron-message").offsetWidth;
        document.getElementById("jumbotron-message").classList.add("fadeOut");
